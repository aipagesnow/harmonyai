            ...
            <div className="p-8 space-y-8">
                ...
                <section className="text-center">
                    ...
                    {(() => {
                        ...
                        const scopes = 'commands,chat:write,channels:history,groups:history,im:history,mpim:history,channels:read,groups:read,im:read,mpim:read,app_mentions:read';
                        const redirectUri = 'https://harmonyai-web.vercel.app/api/slack/oauth';
